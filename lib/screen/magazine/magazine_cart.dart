...
class MagazineCart extends StatefulWidget {
  final magazinedetails;
  MagazineCart({required this.magazinedetails});

  @override
  State<MagazineCart> createState() => _MagazineCartState();
}

class _MagazineCartState extends State<MagazineCart> {
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => MagazineDetails(
                      widget.magazinedetails,
                      widget.magazinedetails.cover_image.toString(),
                    )));
      },
      child: Container(
            ...
            children: [
              Expanded(
                ...
                child: CachedNetworkImage(
                  imageUrl:
                      "https://res.cloudinary.com/boichitro/${widget.magazinedetails.cover_image.toString()}",
              ...
              Expanded(
                ...
                child: Container(
                    ...
                    child: Text(widget.magazinedetails.bookname,
                    ...
                    children: [
                      Expanded(
                          ...
                          child: Container(
                              ...
                              child: AutoSizeText(
                                widget.magazinedetails.author.toString(),
                                style: TextStyle(
                                    // color: Colors.black,
                                    ),
                                maxLines: 1,
              ...
              widget.magazinedetails.is_paid == true
                  ? Expanded(
                      flex: 2,
                      child: Row(
                        children: [
