...
class SomogroBookCart extends StatefulWidget {
  final bookdetails;
  SomogroBookCart({
    required this.bookdetails,
  });
  @override
  _SomogroBookCartState createState() => _SomogroBookCartState();
}

class _SomogroBookCartState extends State<SomogroBookCart> {
