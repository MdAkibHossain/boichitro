...
class SomogroBookDetails extends StatefulWidget {
  final recentlist;
  final bytesImage;
  ...
  @override
  State<SomogroBookDetails> createState() => _SomogroBookDetailsState();
}

class _SomogroBookDetailsState extends State<SomogroBookDetails> {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => SomogroApiCall(
                                              pk: widget.recentlist.pk,
                                              book_slug: widget.recentlist.slug,
                                              book_name: widget
                                                  .recentlist.bookname
                                                  .toString(),
